...
public class MainActivity extends AppCompatActivity
    ...
    private void updateLitePalAndList(int requestCode, Intent it) {
        ...
        OneMemo new_memo = new OneMemo(tag, current_date, current_time, gotAlarm, mainText,title);

        if((requestCode+1)>memolist.size()) {
            // add a new memo record into database
            addRecordToLitePal(num, tag, current_date, current_time, alarm, mainText,title);
    ...
    private void addRecordToLitePal(int num, int tag, String textDate, String textTime, String alarm, String mainText,String title) {
    ...
    private void transportInformationToEdit(Intent it, Memo record) {
        ...
        it.putExtra("title",record.getTitle());
    }
